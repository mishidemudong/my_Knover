...
def shuffledatafile():
    valid_list = [["./data/luge-dialogue/weibo/dev.txt", to_sample_for_weibo, False, False],
    ...
    for [input_list, output_file] in data_process_list:
        truncate_type_stat[0] = truncate_type_stat[1] = truncate_type_stat[2] = truncate_type_stat[3] = \
        truncate_type_stat[4] = 0
        ...
        for [input_file, handle_method, truncate_first_turn, is_test] in input_list:
            ...
            for sample in handle_method(input_file, is_test=is_test):
                numerical = convert_sample_to_numerical(sample, truncate_first_turn=truncate_first_turn,
                                                        is_test=is_test)
